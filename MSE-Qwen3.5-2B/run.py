...
def parse_args():
    ...
    parser.add_argument('--model_save_dir', type=str, default='/mnt/workspace/results/models/qwen3.5',
                        help='path to save results.')
    parser.add_argument('--res_save_dir', type=str, default='/mnt/workspace/results/qwen3.5',
                        help='path to save results.')
    # 修改预训练模型路径
    parser.add_argument('--pretrain_LM', type=str, default='/mnt/workspace/models/Qwen3.5-2B-Base',
    ...
    parser.add_argument('--llm_arch', type=str, default='qwen3_5_base')
    parser.add_argument('--freeze_llm', type=bool, default=True)
    parser.add_argument('--llm_dtype', type=str, default='bf16')   # bf16 / fp16 / fp32
    parser.add_argument('--use_chat_template', type=bool, default=True)
    parser.add_argument('--append_eos_to_label', type=bool, default=True)
