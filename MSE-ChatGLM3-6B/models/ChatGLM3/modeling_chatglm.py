...
class ChatGLMModel(ChatGLMPreTrainedModel):
    ...
    def forward(
            ...
            input_fusion: Optional[bool] = None
    ):
        ...
        if inputs_embeds is None and input_fusion is not None:
            inputs_embeds = self.embedding(input_ids)
            input_fusion = input_fusion.transpose(0, 1).contiguous()
            inputs_embeds[:input_fusion.size(0), :, :] = input_fusion
...
class ChatGLMForConditionalGeneration(ChatGLMPreTrainedModel, GenerationMixin):
    ...
    def prepare_inputs_for_generation(
        ...
        input_fusion = kwargs.get('input_fusion', None)
